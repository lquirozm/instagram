...
const AddPost: React.FC<AddPostProps> = ({ setShowPopUp, setPosts }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
      <div className="animate__animated animate__fadeInUp bg-white rounded-lg shadow-lg w-full max-w-md p-8 relative max-h-[100vh] dark:bg-[#121212]">
        ...
        <div className="flex flex-col gap-3">
          ...
          <input
            ...
            className="focus:outline-none border-2 rounded-lg p-1 dark:bg-[#121212]"
          />
          <button
            onClick={uploadPost}
            disabled={!imageUrl}
